        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.kitob.update',$data->id)}}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')

                        <div class="form-group">
                            <label for=""> Kitob nomi UZ</label>
                            <input type="text" name="name_uz" value="{{$data->name_uz}}" class="form-control"
                                   required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name_ru" value="{{$data->name_ru}}" class="form-control"
                                   required>
                        </div>
                        <div class="form-group">
                            <label for="desc_uz">Qisqacha izoh UZ</label>
                            <textarea class="form-control" name="desc_uz" id="desc_uz" rows="4" >{{$data->desc_uz}}</textarea>
                        </div>

                        <div class="form-group">
                            <label for="desc_en">Qisqacha izoh EN</label>
                            <textarea class="form-control" name="desc_en" id="desc_en" rows="4" >{{$data->desc_en}}</textarea>
                        </div>

                        <div class="form-group">
                            <label for="desc_ru">Qisqacha izoh RU</label>
                            <textarea class="form-control" name="desc_ru" id="desc_ru" rows="4" >{{$data->desc_ru}}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="outor_uz"> Muallif UZ</label>
                            <input type="text" name="outor_uz" value="{{$data->outor_uz}}" class="form-control"
                                   required>
                        </div>
                        <div class="form-group">
                            <label for="outor_en"> Muallif EN</label>
                            <input type="text" name="outor_en" value="{{$data->outor_en}}" class="form-control"
                                   required>
                        </div>
                        <div class="form-group">
                            <label for="outor_ru"> Muallif RU</label>
                            <input type="text" name="outor_ru" value="{{$data->outor_ru}}" class="form-control"
                                   required>
                        </div>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input type="radio" id="age1" @if($data->status==0) checked @endif name="status" value="0">
                            <label for="age1">Oddiy</label><br>
                            <input type="radio" id="age2"  @if($data->status==1) checked @endif  name="status" value="1">
                            <label for="age2">Durdona to'plamlar</label><br>
                            <input type="radio" id="age3"  @if($data->status==2) checked @endif  name="status" value="2">
