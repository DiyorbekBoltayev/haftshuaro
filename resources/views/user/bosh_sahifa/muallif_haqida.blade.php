...
@section('content')
    ...
    <section class="image1 cid-t78ImlaneG" id="image1-9">
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="image-wrapper">
                        <img src="{{asset('front/assets/images/44.jpeg')}}" alt="foto">
    ...
    <section class="video3 cid-t78Ir3egHU" id="video3-b">
        ...
        <div class="container">
            ...
            <div class="row mt-4">
                ...
                <div class="col-12 col-md-6 video-block">
                    ...
                    <p class="mbr-text pt-2 mbr-fonts-style display-4">Video Description</p>
                </div>
            </div>
        </div>
    </section>

    <section class="video3 cid-t78JN5CdSJ" id="video3-c">
