                        ...
                        <div class="text-box">
                            ...
                            @if($lang=="uz")
                                <p class="mbr-text mbr-fonts-style display-7">
                                    ...
                                    qoldirgan markazlaridan biridir. Umumoʻzbek adabiyoti taraqqiyotining har bir
                                    bosqichida
                                    bu muhit vakillarining oʻziga xos oʻrni, betakror ijodiy qiyofasi va nufuzi bor.
                                    Uzoq
                                    tarixiy va adabiy jarayonda shakllangan hamda takomillashib borgan an`analar, badiiy
                                    tafakkur tarzi, she`riyat, madaniyatga ixlosmandlik, boy adabiy manbalarning
                                    mavjudligi
                                    ...
                                    bosqichlardagi ijodiy yutuqlarni va adabiy an`analarning oʻrnini ham qayd etish
                                    zarur.
                                    <br>Bunda, birinchi navbatda, Munis, Ogahiy va Feruzning tashabbuskorligi koʻzga
                                    yaqqol
                                    tashlanadi.
                                    <br>Bizningcha, bu tarixiy davr adabiy muhiti mohiyatini belgilashda XIX asrni
                                    tayanch
                                    ...
                                    qildi. Feruzning bu sohadagi tashabbuskorligi yaqin vaqtlargacha xolis e`tirof
                                    etilmagan
                                    boʻlsa ham, adabiyotimiz jonkuyari, atoqli adib Abdulla Qahhor 1962 yildayoq bu
                                    xususda
                                    ...
                                    keyin qora kursiga oʻtqazib, sovet qonuni bilan sud qilishdan nima murod hosil
                                    boʻladi?
                                    Koʻp xotin olish yolgʻiz Feruzning aybi emas, balki butun feodal jamiyatning
                                    illatidir.
                            ...
                            @endif
                            @if($lang=="ru")
                                <p class="mbr-text mbr-fonts-style display-7">Известно, что литературная среда Хорезма
                                    является узбекской классикой.
                                    ...
                                    Представители этой среды обладают особым положением, неповторимым творческим имиджем
                                    и авторитетом. Длинная
                                    традиции складывались и совершенствовались в историко-литературном процессе,
                                    художественном
                                    ...
                                    отброшен.
                                    <br> На наш взгляд, этот исторический период является основой XIX века в определении
                                    сущности литературной среды.
                                    ...
                                    делал. До недавнего времени инициатива Феруза в этой сфере объективно не
                                    признавалась.
                            ...
                            @endif
                            @if($lang=="en")
                                <p class="mbr-text mbr-fonts-style display-7">It is known that the literary environment
                                    of Khorezm is Uzbek classic
                                    The literature is highly developed and an indelible mark on the development of our
                                    spirituality
                                    is one of the centers left. At every stage of the development of Uzbek literature
                                    Representatives of this environment have a special place, a unique creative image
                                    and prestige. Long
                                    ...
                                    <br> The peak of this environment was in the second half of the 19th century and the
                                    20th century
                                    was the beginning of the twentieth century. At the same time, it is the previous one
                                    that led to the rise
                                    It is also important to note the creative achievements of the stages and the place
                                    of literary traditions.
                                    <br> In this, first of all, the initiative of Munis, Ogahi and Feruz is obvious.
                                    discarded.
                                    <br> In our opinion, this historical period is the basis of the XIX century in
                                    defining the essence of the literary environment
                                    ...
                                    However, Abdullah Qahhor, a well-known writer and a fan of our literature, wrote
                                    about it in 1962.
                                    ...
                                    He bought a printing house and published the first book in Khorezm. This man for a
                                    hundred years
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-12">
                    ...
                    @if($lang=="uz")
                        ...
                        <br> <br>Tazkiraning tadrijiy takomili va janriy belgilariga asoslanib, adabiyotimiz
                        bilimdonlaridan
                    ...
                    @if($lang=="ru")
                        ...
                        В дальнейшем обогащении традиционных тем формальное разнообразие жанров носит в целом
                        ...
                        Добавились общественно-политические и просветительские идеи, произошли некоторые формальные
                        изменения.
                        <br>
                        ...
                        Около пятидесяти художников, вне зависимости от социального положения, профессии и
                        национальности.
                        Они обладали определенным уровнем художественного таланта и создавали произведения в различных
                        жанрах. Их
                        ...
                        <br>
                        <br> 2. Художники, непосредственно участвовавшие в дворцовой службе Ферузом (Табиби, Камиль,
                        Дои,
                        Девани, Мирза, Хабиби, Хадим и др.);
                        <br>
                        <br> 3. Хотя официально он не находился на службе дворца, он находился в поле зрения Феруза и в
                        литературной обстановке.
                        ...
                        <br><br> Основными чертами литературной среды Хорезма начала ХХ века являются
                        общественно-политический период
                        ...
                        <br>
                        <br> а) Литературная среда богата и исторически основана на длительном литературном опыте, их
                        новом
                        сформировалась как продолжение ХХ века и является последним, новым периодом узбекской
                        классической литературы
                        было началом его литературы;
                        <br>
                        <br> б) Большинство представителей литературной среды являются прямыми, а некоторые - косвенными
                        с дворцовыми
                        ...
                        <br>
                        <br> в) Кроме лирической поэзии, являющейся основным литературным произведением творцов, ряд
                        былин,
                        перевод и создание исторических произведений является одной из особенностей литературной среды.
                        В этом отношении
                        ...
                        <br>
                        <br> г) Другой характеристикой литературной среды является разнообразие лирических жанров. В
                        этом районе
                        ...
                        Дальнейшее развитие было в основном творческим, и писать на узбекском и персидском языках было
                        для каждого поэта
                        была своеобразной чертой;
                        <br>
                        <br> д) Еще одним важным аспектом является то, что творчество поэтов было многогранным. они
                        литературные
                        ...
                        появляется. В частности, в число тазкиров входили художники того времени, в том числе Хафт
                        Шуаро.
                        ...
                        дал. Эти факторы заметны в относительном ускорении образования различных байозов, комплексов,
                        тазкиров.
                        ...
                        <br>
                        <br> Байоз, сыгравший важную роль в хорезмийской литературной среде, является типичным для
                        восточной литературы байозом
                        ...
                        В частности, "Байози комплекс аш'ар" и "Байози аш'ор", сочиненные во времена Феруза, отличаются
                        лирическими
                        Он составлен из стихов разных жанров и воспевает тему любви.
                        «Байози мухаммасот» — это только положительные формы, а «Байози рубойот» — это только один из
                        жанров рубаи.
                        ...
                        Стихотворения Муганни - I.X) дает каждому небольшой комментарий о том, когда оно было написано и
                        какое именно.
                        Из источника ясно, что этот период был периодом литературного процесса и конкретного
                        Имеет значение в изучении творческого наследия художника, в определении его
                        идейно-художественной эволюции.
                        зарабатывает» [5].
                        <br>
                        <br> Во-вторых, в сборниках есть краткие биографические сведения об авторах стихов.
                        происходят данные. В этом смысле большинство коллекций в основном представляют собой
                        ...
                        также могут быть составлены из стихов, а в байозах, как правило, поэтические фрагменты не
                        ограничиваются,
                        ...
                        <br>
                        <br> Тазкира обычно представляет собой литературный или критический взгляд на определенный
                        исторический период.
                        ...
                        Существование интерпретации данных показало, что тазкира является фундаментальной особенностью
                        Хорезма.
                        Он также был источником вдохновения и поддержки для своего тазкира.
                        <br><br> Правда, в Хорезме только в 20 веке были созданы классические образцы тазкиризма. Но это
                        так
                        Это не дефект литературной среды, а ее самобытность, и основной упор делается на самобытное
                        искусство.
                        произведения, литературно-исторические хроники, а также переводные произведения
                        объяснил. Однако некоторые элементы тазкиры присутствуют в ряде произведений, написанных до ХХ
                        века.
                        ...
                        <br>
                        Кроме того, в этом произведении Огахи описывает свое состояние, психику, литературные прозвища,
                        ученых и поэтов.
                        ...
                        формируется на основе интереса. Действительно, «такие сборники произведений были первыми
                        тазкирами» [9]. Так,
                        Основу классических тазкирас составляет сборник, который постепенно становится
                        литературно-критическим, даже,
                        обогащается и совершенствуется теоретическими знаниями. Вот почему тазкира является литературным
                        комплексом.
                        Наличие фрагментов не противоречит требованиям жанра, а является одной из его особенностей.
                        Середина
                        ...
                        краткая информация о некоторых особенностях; в) в произведениях, произведениях, произведениях
                        поэта
                        ...
                        информация предоставляется только при наличии личного знакомства между поэтом и рассказчиком);
                        г)
                        любой интересный рассказ или анекдот о поэте, сохранившийся в устах народа или в памяти автора;
                        д)
                        ...
                        Естественно, что идеи имеют приоритет. Это литературный период, когда они создали группировку
                        тазкира.
                        ...
                        На первый план вышли труды сотрудников. К сожалению, они до сих пор специально не изучены.
                        (Лаффасий
                        ...
                        <br>
                        <br> Из них работа Лаффази представляет собой историко-современную версию тазкиры (в которой он
                        жил в прошлом).
                        Есть сведения о Мунисе и Огахи), а остальное к комментарию современников.
                        принадлежит.
                        <br>
                        <br> Характерной чертой является то, что традиционные хорезмийские тазкиры представляют собой
                        жанр литературных фрагментов.
                        ...
                        Информация о деятельности Судя по всему, тазкира содержит литературное произведение
                        (поэтическое)
                        текст), а оценка жизни и творчества поэта - явление типологическое. Но уверен в некоторых
                        комплексах
                        ...
                        В данном случае ученый ссылается только на тазкира-специфические сведения о биографии Лютфи в
                        работе
                        ...
                        Он содержит богатую информацию о литературной среде ферузского периода, жизни и творчестве его
                        поэтов.
                        даны. Автор этого произведения в форме воспоминаний является непосредственным свидетелем фактов
                        и табличек, содержащихся в нем.
                        ...
                        написал.
                        <br>
                        <br> Эти вопросы во многом являются общими для членов тазкира, упомянутых выше М. Шайхзода.
                        Боеприпасы
                        Потому что резюме сотрудника основано на воспоминаниях и содержит биографические данные
                        Он не цитирует литературные отрывки, а кратко отмечает роль каждого поэта в литературном
                        процессе.
                        ...
                        является характеристикой произведения. По этой причине литературовед Г.Исмаилова назвала его
                        «Маджмуат уш-
                        шуаро» и с именами многих художников
                        Мы сможем познакомиться»[17].
                        <br>
                        <br> Литературоведы Н. Джумаходжа и И. Адизова
                        Подчеркивая историческую и литературную значимость, они приходят к следующему обоснованному
                        выводу: «его тазкира
                        Отличие и преимущество этого вида литературного источника в том, что это взгляд на литературную
                        среду,
                        процессы, идеологическая жизнь живая, в движении, с общественно-политическими событиями
                        описывает отношения» [18].
                        <br>
                        <br> Вышеприведенные факты и свидетельства богаты сведениями о литературной среде Хорезма начала
                        ХХ века,
                        ...
                        Одна из рукописей, монографическое исследование тазкира-комплекса «Хафт Шуаро» ферузского
                        периода.
                        ...
                        исправить некоторые из существовавших до сих пор ошибочных, односторонних взглядов на
                        произведения искусства
                        ...
                        <br>
                        <br> [8] Огаий. Гульшанское государство. Фонд Института востоковедения АН РУз Инв. №7572-Б
                        101-102.
                        <br>
                        ...
                        <br>
                        <br>
                        <br> [13] Хайитметов. А. Первое теоретическое пособие по литературе на турецком языке //
                        Узбекский язык и
                        литературы.Т., 2002.№ 1. -С.72.
                        <br>
                        <br> [14] Сотрудник. Хорезмские музыканты. - Т.: Литература и искусство, 1994. 96-с.
                        <br>
                        <br> [15] Валиксоджаев Б., Холматов.Ш. История узбекского литературоведения. Часть 1.
                        Самарканд., 1983-Б.
                        13.
                        <br>
                        ...
                        <br>
                        <br> [17] Исмаилова Г. Феруз периода Хорезмской литературной среды. Фил. фан.номз. диссертация.
                        Т.: Фан, 1995-
                        Б. 25.
                        <br>
                    ...
                    @if($lang=="en")
                        ...
                        In the further enrichment of traditional themes, the formal diversity of genres is, in general,
                        artistic
                        ...
                        <br>
                        <br> Naturally, the driving force of the literary environment is the creators. In this respect
                        Feruz
                        It is necessary to emphasize the organized nature of the environment. The important thing is
                        ...
                        <br>
                        <br> 1. Artists belonging to the family of Feruz (Murodi, Komyob, Farrukh, Sultani, Sadiq,
                        Sa`di,
                        Wise, Statement, etc.);
                        <br>
                        ...
                        <br>
                        <br> 3. Although not officially in the service of the palace, it was in Feruz's view and in a
                        literary setting
                        artists who left a significant mark (Avaz, Niyazi, Mutrib, Faqiri, Sufi, etc.).
                        <br>
                        <br> Feruz's attitude to the creators was the main criterion of their artistic potential. That's
                        right
                        ...
                        <br><br> The main features of the Khorezm literary environment of the early twentieth century
                        are the socio-political period
                        ...
                        <br>
                        <br> a) The literary environment is rich and historically based on long literary experiences,
                        their new
                        was formed as a continuation of the twentieth century and is the last, new period of Uzbek
                        classical literature
                        was the beginning of his literature;
                        <br>
                        <br> b) Most of the representatives of the literary environment are direct, and some are
                        indirect with the palace
                        Although bound, Feruz as king was their general patron and organizer of the environment,
                        was a creative partner as a poet;
                        <br>
                        <br> c) In addition to lyrical poetry, which is the main literary product of the creators, a
                        number of epics,
                        translation and the creation of historical works is one of the features of the literary
                        ...
                        <br>
                        <br> d) Another characteristic of the literary environment is the diversity of lyrical genres.
                        In this area
                        The Agahi tradition of the teacher, who created in about twenty genres and forms, was continued
                        and
                        Some of the poets wrote in fourteen genres. Of course, among them are gazelles and
                        muhammas play a key role;
                        <br>
                        d) Navoi, Fuzuli, Munis and Ogahi in the creative development of the representatives of the
                        literary environment
                        The enjoyment of genius, as well as the tradition of Zul-Sunanism, was an important factor. To
                        teachers
                        ...
                        <br>
                        In general, these features contribute to the development of culture and art, the literary
                        process
                        ...
                        was introduced.
                        <br><br> Indeed, the introduction of lithography contributed to the revival of the literary
                        environment,
                        It is possible to increase the motivation of creators and increase the number of sources in the
                        form of books
                        gave. These factors are noticeable in the relative acceleration of the formation of various
                        bayoz, complex, tazkira
                        played a role. However, this did not completely displace the practice of manuscripts. Mullah in
                        this field
                        ...
                        <br>
                        <br> Bayoz, which played an important role in the Khorezmian literary environment, is a bayoz
                        typical of Eastern literature
                        In addition to reflecting the main features of the tradition, it also has a certain uniqueness.
                        This is reflected in the genre and thematic stratification of the bayoz, as well as in the
                        zullisonain.
                        In particular, "Bayozi complex ash'ar" and "Bayozi ash'or" composed in Feruz's time are
                        different lyric
                        ...
                        compiled by order.
                        <br>
                        <br> Naturally, they say, “About the person who ordered the creation of Bayaz and the poet of
                        the composer
                        through the ideological content of the poems in which the subjective perception and feelings are
                        bayoz
                        ...
                        contains a large part of the creative heritage. Their structure depends on the purpose of the
                        compiler,
                        ...
                        romantic-enlightenment theme, and in the poems of the complex "Yugurum" (1923) a revolutionary
                        theme
                        ...
                        It is important in the study of the creative heritage of the artist, in determining its
                        ideological and artistic evolution
                        earns ”[5].
                        <br>
                        <br> Secondly, there is a brief biographical account of the authors of the poems in the
                        collections.
                        ...
                        <br>
                        <br> Some valuable information about the literary environment of Khorezm is contained in the
                        tazkiras
                        ...
                        There are two sides to the tazkira - the text (poetic fragments) and the life and works of the
                        artist
                        ...
                        <br><br> It is true that in Khorezm it was not until the 20th century that classical examples of
                        tazkirism were created. But that's the case
                        It is not a defect of the literary environment, but its originality, and the main focus is on
                        the original art
                        works, literary-historical chronicles, as well as translated works
                        explained. However, there are some elements of tazkira in a number of works written before the
                        twentieth century
                        - Brief information about the literary environment of a certain period, the life and work of
                        poets. This
                        ...
                        <br>
                        In addition, in this work, Ogahi describes his condition, psyche, literary nicknames, and
                        scholars and poets.
                        ...
                        formed on the basis of interest. Indeed, "such collections of works were the first tazkiras"
                        [9]. So,
                        The basis of classical tazkiras is a collection, which is gradually becoming a
                        literary-critical, even,
                        enriched and improved with theoretical insights. This is why the tazkira is a literary complex
                        The presence of fragments is not contrary to the requirements of the genre, but one of its
                        features. Medium
                        In the city of Khiva, which has become one of the largest cultural and literary centers since
                        the XIX century, in particular, from the XIX century
                        creation of works of art, compilation, reading and promotion
                        During the Feruz period from the end of that century to the beginning of the 20th century, it
                        became more widespread
                        did. After all, classical tazkiraism occurs in the same period and is different in a short time
                        the structure of the tazkirs of the character is also proved by these factors. True, in this
                        period
                        A number of commentaries also appeared in the literary circles of Kokand and Bukhara (Fazliy,
                        Pirmastiy
                        ...
                        the attitude of the author and, conversely, the position of the poet in relation to the narrator
                        (this
                        information is provided only if there is a personal acquaintance between the poet and the
                        narrator); G)
                        any interesting story or anecdote about the poet, preserved in the mouths of the people or in
                        the memory of the author; e)
                        ...
                        of course)" [11].
                        <br>
                        <br> The basis of this form, which is characteristic of the perfect tazkir in the literal sense,
                        is twofold.
                        characterization of the poet as a creative person and interpretation of the evaluation of his
                        works.
                        ...
                        traditions are explained by factors such as the purpose and ability of the storyteller. Because
                        of this, some
                        about literary views in tazkirs, some examples from the poet's poems
                        Naturally, ideas take precedence. This is the literary period when they created the tazkir
                        grouping.
                        In addition to its features, it also implies a structural and semantic specificity in the
                        development of the genre.
                        needs to be carried out. These tazkirs are relatively significant tazkirs of the 19th and 20th
                        centuries.
                        especially important when defining the essence.
                        <br>
                        <br> Literary critic B. Valikhodzhaev divided the tazkirs into two groups according to the time
                        factor.
                        distinguishes: 1) historical-modern (predecessors and contemporaries); 2) about contemporaries
                        tazkiralar [12]. The features of each of them are analyzed in detail. Scientist in Central Asia
                        X
                        ...
                        The work of the employees came to the fore. Unfortunately, they have not yet been specifically
                        studied. (Laffasius
                        ...
                        <br>
                        <br> Of these, Laffasi's work is a historical-modern version of tazkirah (in which he lived in
                        the past).
                        There is information about Munis and Ogahi), and the rest to the commentary on contemporaries.
                        belongs to.
                        <br>
                        <br> The characteristic feature is that the traditional Khorezm tazkiras are a genre of literary
                        fragments.
                        ...
                        <br>
                        <br> Of course, along with the attitude to these works mentioned in the tazkira, the life of the
                        poets and
                        Information on the activities of Apparently, the tazkira contains a literary piece (poetic)
                        text) and the assessment of the poet's life and work is a typological phenomenon. But certain in
                        some complexes
                        ...
                        In this case, the scholar refers only to the tazkira-specific information about Lutfi's
                        biography in the work
                        ...
                        information is also provided. After all, Haft Shuaro itself is mainly a complex, partly tazkira
                        feature
                        ...
                        It contains rich information about the literary environment of the Feruz period and the life and
                        work of its poets
                        are given. The author of this work in the form of memoirs is a direct witness to the facts and
                        plates in it.
                        The content of the work gives full grounds to call it tazkira, because “tazkira in the sense of
                        a notebook
                        ...
                        <br>
                        <br> In the Tazkirah, the author answers thirteen questions on the "condition of thirty-one
                        poets."
                        wrote.
                        <br>
                        <br> These questions are in many respects common to the members of the tazkira mentioned above
                        by M. Shaykhzoda. Ammo
                        Because the employee's resume is based on memories and contains biographical information
                        It does not quote literary passages, but briefly notes the role of each poet in the literary
                        process
                        reported. Importantly, the versatility of the poets' work is also reflected. Also a work
                        The personality and creativity of the poets in Tabibi and Laffasi's commentaries, in particular
                        in Haft Shuaro
                        ...
                        is characteristic of the work. For this reason, the literary critic G.Ismailova called it
                        Tabibi's “Majmuat ush-
                        ...
                        Emphasizing the historical and literary significance, they come to the following reasonable
                        conclusion: “his tazkira
                        The difference and advantage of this type of literary source is that it is a view of the
                        literary environment,
                        processes, ideological life alive, in motion, with socio-political events
                        describes the relationship ”[18].
                        <br>
                        <br> The above facts and evidence are rich in information about the literary environment of
                        Khorezm in the early twentieth century,
                        ...
                        The greater the number of manuscripts, the more the district spreads and the problem becomes
                        clearer.
                        ...
                        by allowing to "clarify" aspects of the literary environment that have so far been little
                        studied
                        valuable.
                        <br><br> In general, the complex and the tazkira are close to the literature under the pretext
                        of "palace literature".
                        ...
                        to study the environment as a whole and to evaluate it objectively on the basis of new
                        scientific thinking
                        allows.
                        <br> <br>
                        <hr>
                        ...
                        <br>
                        <br> [5] Abdugafurov A. "Yugurmiya" - a collection of Uzbek revolutionary poems // Uzbek
                        language and
                        ...
                        1993-B.118.
                        <br>
                        <br> [7] Ogahiy. Riyazud state. Fund of the Institute of Oriental Studies of the Uzbek Academy
                        of Sciences Inv. № 5364 II-B.374-a.
                        <br>
                        <br> [8] Ogahiy. Gulshani state. Fund of the Institute of Oriental Studies of the Uzbek Academy
                        of Sciences Inv. №7572 -B 101-102.
                        <br>
                        <br> [9] Mallayev N. Historical and literary significance of XV century tazkira // Uzbek
                        literature
                        ...
                        Toshkent.2004.-B 43-46.
                        <br>
                        <br> [11] Shaykhzoda M. From the history of tazkirachilik // A gift to Navoi. Collection. T.,
                        1968- B. 49.
                        <br>
                        ...
                        <br>
                        <br>
                        <br> [13] Hayitmetov. A. The first theoretical guide to literature in Turkish // Uzbek language
                        and
                        literature.T., 2002.№ 1. -B.72.
                        <br>
                        <br> [14] Employee. Khorezm musicians. - T .: Literature and art, 1994. 96-p.
                        <br>
                        <br> [15] Valixoʻjayev B., Kholmatov.Sh. History of Uzbek literary criticism. Part 1.
                        Samarkand., 1983-B.
                        13.
                        <br>
                        ...
                        <br>
                        <br> [17] Ismailova G. Feruz period Khorezm literary environment. Phil. fan.nomz. dissertation.
                        T .: Fan, 1995-
                        B. 25.
                        <br>
                        <br> [18] Jumakhoja N, Adizova I. There is no monument to the word.-T .: Uzbekistan, 1995- P.
                        148
                        <br>
                        <br> [19] Bertels. E.E. Voprosy metodiki kriticheskix izdaniy klassicheskix pamyatnikov
                        literatury
                        narodov Blijnego i Srednego Vostoka // Materialy Vsesoyuznoy konferensii vostokovedov v
                        Tashkente.
