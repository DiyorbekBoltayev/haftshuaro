                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg">
                        <div class="text-box">
                                ...
                                zamonaviy adabiyotini xalqaro miqyosda oʻrganish va targʻib qilish, bugungi kunda dunyo
                                ...
                                etib, zarur ilmiy-amaliy xulosalar chiqarish, katta ahamiyatga ega”[3].<br></p>
                                 ...
                                 @if($lang=="ru")
                                    <p class="mbr-text mbr-fonts-style display-7">У каждого народа своя история
                                        ...
                                        является одним из факторов. Многие из этих ценностей находятся в рукописном и литографическом виде.
                                        ...
                                        анализ в тесной связи с важнейшими процессами, происходящими в литературном пространстве
                                 ...
                                 @if($lang=="en")
                                    <p class="mbr-text mbr-fonts-style display-7">Each nation has its own history
                                        ...
                                        is shown in [2].
                                        <br> Spiritual values ​​are the basis of a person and his upbringing, leading to maturity
                                        is one of the factors. Many of these values ​​are in manuscript and lithographic form
                                        ...
                                        analysis in close connection with the most important processes taking place in the literary space
                                        It is important to draw the necessary scientific and practical conclusions. ”[3]. <br></p>
                                 @endif
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-12">
                    ...
                    @if($lang=="uz")
                    <p class="mbr-text mbr-fonts-style display-7">[1] Qadriyatlar va ijtimoiy taraqqiyot (ilmiy ishlar
                        toʻplami). –T; “Oʻzbekiston”, 1997. B.198; Komilov T., Abidova S. Milliy axloqiy qadriyatlar va
                    ...
                    @endif
                        @if($lang=="ru")
                        <p class="mbr-text mbr-fonts-style display-7">[1] Ценности и общественное развитие (научная работа
                            коллекция). –Т; «Узбекистан», 1997. С.198; Камилов Т., Абидова С. Национальные нравственные ценности и
                            их воспитательное значение. ФА УзР, «Веер», 2000. С.20;
                            <br> Артиков Н.В. Духовность: национальные и общечеловеческие ценности. - Т; «Узбекистан», 1997.Б.48.
                    ...
                    <div class="card-wrapper">
                        ...
                        <div class="bottom-line">
                            ...
                            <p class="mbr-text mbr-fonts-style display-7">Darhaqiqat, tarixiy taraqqiyot jarayonida
                                ajdodlarimiz tomonidan yaratilgan milliy-ma`naviy qadriyatlarni oʻrganish, ularni joriy
                                ...
                                <br>
                                <br>Shoʻro davri mafkurasi adabiy merosga partiyaviylik va sinfiylik tamoyillari asosida
                                ...
                                oxiri, XX asrning boshida ijod qilgan va she`riyatda muayyan iz qoldirgan yetti nafar
                                ...
                                adabiy muhit tarixi tadqiqining boʻsh qolgan sahifalarini toʻldirishga xizmat qiladi. Bu
                                ...
                                jarayonning oʻziga xos xususiyatlarini va Feruz shajarasiga mansub shoirlarning badiiy
                                ijoddagi hissasini aniqlash hamda davr adabiy muhitini yaxlit, uyushgan hodisa sifatida
                                tushunishga imkon beradi. Bu hol adabiyotshunoslikda xolislik tamoyili izchil amalga
                                oshirilayotgan hozirgi kunda, ayniqsa, muhim boʻlib, ushbu tadqiqotning dolzarbligini
                                belgilaydi.
                                <br>
                                <br>“Haft shuaro”ga munosabat dastlab shahzoda shoirlar zamondoshlarining asarlari va
                                esdaliklaridan boshlangan. Jumladan, Hasanmurod Laffasiy (1880-1949) tazkirasidagi
                                Murodiy, Farrux, Sultoniy, Sa`diy va Bayoniy haqidagi ma`lumotlarda ularning she`rlari
                                ...
                                davrda boʻlgan butun shoirlarning nazmlarini Muhammad ikkinchiga oʻqib berar hamda nashr
                                ...
                                yetkurdim”[1]. Muhimi shundaki, ana shu oʻttiz bir nafar shoir orasida “Haft shuaro”ga
                                she`rlari kiritilgan Sultoniy, Sodiq, Sa`diy, Bayoniy va Oqil ham bor edi. Garchi Xodim
                                ...
                                mumkin: 1) 60-yillardan 90-yillargacha; 2) mustaqillik davri bosqichi. Adabiy merosga
                                yondashuv xususiyatlari har bir bosqichda oʻziga xos ifodasini topdi. Birinchi bosqichda
                                “Haft shuaro”ga kirgan shoirlardan faqat Bayoniy ijodiga nisbatan xolislik koʻringan
                                boʻlsa, ikkinchi bosqichda yetti nafar shoir va ularning asarlari xususida ham muxtasar
                                boʻlsa-da, ayrim fikrlar aytila boshlandi.
                                <br>
                                <br>Akademik V.Abdullayevning 80-yillardagi tadqiqotlarida shahzoda shoirlarning
                                Navoiyga izdoshligi masalasiga doir fikrlar mavjud. Jumladan, adabiyotshunos “Navoiy va
                                bir davrning ikki shoiri” maqolasida Farrux va Bayoniyning Navoiy an`analariga
                                munosabatiga toʻxtalar ekan, Bayoniy dunyoqarashidagi nuqtai nazar va gʻoyaviy saviya
                                koʻlamini alohida ta`kidlab, uni “bedorlik, hushyorlik, ma`nidorlik shoiri”, Navoiyning
                                chinakam izdoshi sifatida ta`riflaydi[2]. “Navoiyga ijodiy izdoshlik mezoni haqida”
                                sarlavhali maqolasida esa Sultoniyning ayrim tatabbu` gʻazallari va taxmislarini tahlil
                                etib, unga “xalq hayoti, orzu-havasi bilan aloqador boʻlgan, Navoiydagi masalalarni
                                chetlab oʻtgan va Navoiydagi dunyoviylik mezonini buzib, ilohiylikni boʻrttirgan” shoir
                                sifatida ijodiga salbiy baho beradi[3].
                                <br>
                                <br>Adabiyotshunos N.Qobulov esa oʻzining “XIX asr oxiri va XX asr boshlarida Xorazmda
                                madaniy va adabiy hayot” maqolasida shahzoda shoirlar ijodiga munosabat bildirib,
                                “feodal saroy adabiyotining eng muhim belgilari taqlidchilik, shaklbozlik, payravchilik,
                                madhiyabozlik avj olishi bilan xarakterlanadi” deb hukmron mafkuraga muvofiq tavsiflaydi
                                va dalil sifatida Murodiy, Farrux, Sultoniy she`rlaridan ayrim parchalar keltiradi[4].
                                <br>
                                <br>90-yillarning boshidan mustaqillik mafkurasi tufayli yangilangan ilmiy tafakkurda
                                ...
                                I.Adizova, G.Ismoilovalarning risola va maqolalari alohida e`tiborga loyiqdir. Xususan,
                                1991-1995 yillarda Feruzga bagʻishlab chop etilgan ommabop ikki kitobdagi tarixiy-badiiy
                                lavhalarda shahzoda shoirlarning hayoti va ijodi toʻgʻrisida qimmatli ma`lumotlar bayon
                                etilgan. Jumladan, birinchi kitobda Murodiy, Oqil, Sodiq, Sultoniy, Sa`diy tarjimai holi
                                va asarlariga doir muxtasar faktlar bor[5]. Ikkinchi kitobda yuqoridagi fikrlar davom
                                ettirilib va boyitilib, shahzoda shoirlar yetti nafarining ham badiiy merosi haqida fikr
                                yuritiladi va ularning adabiy muhitdagi oʻrni umumiy tarzda ta`kidlanib, quyidagi asosli
                                xulosaga kelinadi: “Haft shuaro” majmuasi ham Xorazm adabiy muhitini oʻrganishda muhim
                                manbalardan biri, uni oʻrganish va targʻib qilishdan adabiyot foyda koʻrsa koʻradiki,
                                ...
                                qolmoqda”[6].
                                <br>
                                <br>Adabiyotshunos G.Ismoilova bu fikrlarni quvvatlab, shunday yozadi: “Saroy maddohi”,
                                “taqlidchi”, “ijodi payrav she`rlardangina iborat” deb talqin qilingan koʻpgina qalam
                                ahlining she`rlarini sinchiklab kuzatsak, ularning zamona taqozosi bilan oʻz koʻnglidagi
                                ...
                                <br>
                                <br>Koʻrinadiki, yuqorida qayd etilgan risola va maqolalarda “Haft shuaro”ni batafsil
                                oʻrganish, undagi shoirlar hayoti va she`rlarini monografik yoʻnalishda maxsus tadqiq
                                etish maqsadi qoʻyilmagan. Shu tufayli yangilangan davrda turli adabiy muhit va
                                yoʻnalishlardan iborat yagona oʻzbek milliy adabiyotini yaxlit holda birlamchi manbalar
                            ...
                            <p class="mbr-text mbr-fonts-style display-7">Ведь в процессе исторического развития
                                ...
                                Литературная среда Хорезма занимает особое место. В этой среде продолжают существовать многовековые классические традиции.
                                обогащалась и обогащалась, возникла уникальная литературная школа. Король и поэт Феруз
                                ...
                                были собраны стихи.
                                <br>
                                <br> Советская идеология основана на принципах партийности и классичности в литературном наследии
                                ...
                                цену не узнал. Однако это наследие является новым для литературного процесса того времени.
                                ...
                                и литературная среда ферузского периода, в которой есть аспекты художественного творчества
                                расширяет наше воображение. Хафт Шуаро также является литературным произведением начала ХХ века.
                                особенности процесса и творчества поэтов семьи Феруз
                                определить вклад творчества и литературной среды периода в целом, организованного явления
                                позволяет понять. При этом в литературе последовательно реализуется принцип объективности.
                                Актуальность данного исследования особенно важна сегодня
                                определяет
                                <br>
                                <br> Отношение к «Хафт Шуаро» изначально основывалось на произведениях современников князя поэтов и
                                началось с воспоминаний. В частности, в воспоминаниях Хасанмурада Лаффаси (1880-1949)
                                ...
                                Хотя Хафт Шуаро прямо не упоминается, вышеупомянутые поэты являются биографическими и
                                раскрывает новую информацию о некоторых аспектах его творчества.
                                <br>
                                <br> Мысли о Хафте Шуаро Ряд статей начала 1960-х и
                                начинает появляться в памфлетах, и, конечно, в них, по обычаю того времени, дворцовая
                                творческие люди, близкие к литературной среде, особенно правителям, и отрицательно относящиеся к их произведениям
                                ...
                                возможно: 1) с 60-х по 90-е годы; 2) этап периода независимости. Литературное наследие
                                ...
                                описывает его как истинного последователя [2]. «О критериях творческого поиска Навои»
                                ...
                                «Важнейшими чертами феодальной придворной литературы являются подражание, формальность, покровительство,
                                Характеризуется подъемом гимнов».
                                и приводит в качестве доказательства отрывки из стихов Муради, Фарруха и Султани.
                                <br>
                                <br> В обновленном научном мышлении благодаря идеологии независимости с начала 90-х гг.
                                Примерами объективного подхода к литературному наследию являются произведения поэтов родословной Феруз.
                                ...
                                Историко-художественные произведения в двух популярных книгах, посвященных Ферузу в 1991-1995 гг.
                                Таблички содержат ценные сведения о жизни и творчестве княжеских поэтов.
                                сообщил. В частности, первая книга содержит биографии Муроди, Акила, Садика, Султани, Саади.
                                и краткие сведения о его работах [5]. Продолжите вышеизложенные идеи во второй книге.
                                ...
                                Делается вывод о важности комплекса Хафт Шуаро и в изучении хорезмийской литературной среды.
                                Одним из источников является то, что литература получает пользу от ее изучения и популяризации.
                                ...
                                остается» [6].
                                <br>
                                <br> Литературовед Г.Исмаилова поддерживает эти идеи и пишет: «Дворцовая субстанция»,
                                Многие ручки трактуются как «подражатели», «его творчество состоит только из стихов».
                                Если мы внимательно посмотрим на стихи людей, то увидим, что они были в их сердцах требованиями времени.
                                как умело они выражали свои нежные чувства и душевные боли
                                мы будем свидетелями» [7].
                                <br>
                                <br> Это также литературно-эстетическая ценность и классика творчества поэтов в дворцовой среде.
                                его вклад в обогащение нашей поэзии важен и в ряде других исследований.
                                сформулированы идеи свойств [8].
                                <br>
                                <br> Судя по всему, в вышеупомянутых памфлетах и ​​статьях подробно рассказывается о Хафте Шуаро.
                            ...
                            @endif
                                @if($lang=="en")
                            <p class="mbr-text mbr-fonts-style display-7">Indeed, in the process of historical development
                                The study of national and spiritual values ​​created by our ancestors, their introduction
                                Spelling and making it available to a wide audience is one of the most important issues
                                is one.
                                <br>
                                <br> Some of these values ​​were created in the early twentieth century
                                The Khorezm literary environment has a special place. In this environment, centuries-old classical traditions continue
                                ...
                                The book and its propaganda are widespread, including bayoz, devon, tazkira, and complexes
                                formed. One of them is the Haft Shuaro complex, which houses the prince's poets
                                poems were collected.
                                <br>
                                <br> Soviet ideology is based on the principles of partisanship and classism in literary heritage
                                artists and their works related to the palace environment,
                                including Haft Shuaro, has not been studied. However, in this complex of the XIX century
                                finally, seven who created in the early twentieth century and left a certain mark on poetry
                                samples of the poet's legacy in various genres are collected. Poetic works in it
                                The composition, literary and biographical information is not yet covered in science, and its own
                                did not get the price. However, this legacy is new to the literary process of the time
                                to discover artists, to study and promote their work in detail;
                                serves to fill in the blanks of the study of the history of the literary environment. This
                                and the literary environment of the Feruz period, in which there are aspects of artistic creativity
                                expands our imagination. Haft Shuaro is also a literary work of the early twentieth century
                                the peculiarities of the process and the art of the poets of the Feruz family
                                to determine the contribution of creativity and the literary environment of the period as a whole, organized phenomenon
                                allows you to understand. In this case, the principle of objectivity is consistently implemented in literature
                                The relevance of this study is particularly important today
                                defines
                                <br>
                                <br> The attitude to "Haft Shuaro" was originally based on the works of contemporaries of the prince poets and
                                started from memories. In particular, in the memoirs of Hasanmurad Laffasi (1880-1949)
                                ...
                                I wrote these statements with my own hand, with my own mind, and sent them to the border
                                yetkurdim ”[1]. What is important is that Haft Shuaro is one of those thirty-one poets
                                There were also Sultani, Sadiq, Sa`di, Bayani and Aqil. Although Employee
                                Although he does not mention Haft Shuaro directly, the above poets are biographical and
                                ...
                                begins to appear in the pamphlets, and, of course, in them, according to the custom of the time, the palace
                                creative people close to the literary environment, especially the rulers, and negative to their works
                                ...
                                possible: 1) from the 60s to the 90s; 2) the stage of the independence period. Literary heritage
                                ...
                                There are opinions on the issue of following Navoi. In particular, the literary critic “Navoi and
                                In the article "Two poets of the same period" to the Navoi traditions of Farrukh and Bayani
                                The point of view and ideological level of the Bayani worldview
                                Emphasizing the scale of Navoi, he was called a "poet of vigilance, vigilance, meaning."
                                ...
                                <br>
                                <br> Literary critic N.Kobulov wrote in his book “Khorezm in the late 19th and early 20th centuries
                                In the article "Cultural and literary life" the prince commented on the work of poets,
                                “The most important features of feudal court literature are imitation, formality, patronage,
                                ...
                                <br>
                                <br> In a renewed scientific thinking due to the ideology of independence since the early 90s
                                Examples of an objective approach to literary heritage are the works of poets of the Feruz family tree
                                began to appear in the study. In this field N.Jumahoja, D.Rahim, Sh.Matrasul,
                                The brochures and articles of I.Adizova, G.Ismailova deserve special attention. In particular,
                                ...
                                reported. In particular, the first book contains biographies of Murodi, Aqil, Sadiq, Sultani, Sa`di
                                and there are brief facts about his works [5]. Continue the above ideas in the second book
                                enriched and enriched, the prince thinks of the artistic heritage of all seven of the poets
                                and their place in the literary environment is generally emphasized and based on the following
                                It is concluded that the Haft Shuaro complex is also important in the study of the Khorezmian literary environment
                                One of the sources is that literature benefits from its study and promotion.
                                will not be harmed at all. Therefore, “Haft Shuaro”, “Tazkirai si Shuaroi Feruzshahi”
                                ...
                                If we look closely at the poems of the people, we can see that they are in line with the demands of the times
                                how skillfully they expressed their tender feelings and heartaches
                                we will witness ”[7].
                                <br>
                                <br> It is also a literary-aesthetic value and a classic of the poets' work in the palace environment
                                its contribution to the enrichment of our poetry is also important in a number of other studies
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-12">
                    ...
                    @if($lang=="uz")
                    <p class="mbr-text mbr-fonts-style display-7">[1] Bobojon Tarroh – Xodim. Xorazm navozandalari.-T.:
                        ...
                        1991-B.78-85.
                        <br>
                        <br>[6] Rahim D., Matrasul Sh., Jumaxoʻja N. Feruz. Ikkinchi kitob. –T.: Oʻzbekiston, 1995-B.45.
                        <br>
                        ...
                        Feruz.// Xalq soʻzi. 1992. 29 yanvar. Jumaxoʻja N. Adizova I. Soʻzdin baqoliroq yodgor yoʻqdur–
                        T.: Oʻzbekiston, 1995 -B.150
                        <br>
                        <br>[1] Laffasiy H. Tazkirai shuaro. OʻzRFA Sharqshunoslik instituti qoʻlyozmalar fondi. Inv.№
                        9494; Laffasiy H. Tazkirai shuaro. Urganch: Xorazm, 1992- 119-B.</p>
                    @endif
                        @if($lang=="ru")
                            <p class="mbr-text mbr-fonts-style display-7">[1] Бободжон Таррох — Сотрудник. Хорезмские музыканты.-Т.:
                                ...
                                <br>
                                <br> [4] Кобулов Н., Муминова В., Хаккулов И. Аваз и его литературная среда - Т.: Наука, 1987-
                                Б.25-30
                                <br>
                                <br> [5] Рахим Д., Матрасул Ш. Феруз. Судьба короля и поэта. –Т.: Литература и искусство,
                                1991-Б.78-85.
                                <br>
                                <br> [6] Рахим Д., Матрасул Ш., Джумаходжа Н. Феруз. Вторая книга. –Т.: Узбекистон, 1995-С.45.
                                <br>
                                <br> [7] Исмаилова Г. Феруз периода Хорезмской литературной среды. Филол.фанлари.номз. диссертация. Т.: ТАЙ,
                                1995- С.31-32.
                                <br>
                                <br> [8] Джумаходжа Н. Феруз – меценат культуры и искусства. –Т.: Фан, 1996 – С.89. Тот же автор.
                                Феруз.// Народное слово. 1992. 29 января. Джумаходжа Н. Адизова И. Нет лучшего памятника слову –
                        ...
                        @endif
                        @if($lang=="en")
                            <p class="mbr-text mbr-fonts-style display-7">[1] Bobojon Tarroh - Employee. Khorezm musicians.-T .:
                                ...
                                <br>
                                <br> [4] Kobulov N., Muminova V., Hakkulov I. Avaz and its literary environment - T .: Science, 1987-
                                B.25-30
                                <br>
                                <br> [5] Rahim D., Matrasul Sh. Feruz. The fate of the king and the poet. –T .: Literature and art,
                                1991-B.78-85.
                                <br>
                                <br> [6] Rahim D., Matrasul Sh., Jumaxoʻja N. Feruz. The second book. –T .: O`zbekiston, 1995-B.45.
                                <br>
                                <br> [7] Ismailova G. Feruz period Khorezm literary environment. Filol.fanlari.nomz. dissertation. T.:TAI,
                                1995- P.31-32.
                                <br>
                                <br> [8] Jumakhoja N. Feruz is a patron of culture and art. –T .: Fan, 1996 -P.89. The same author.
                                Feruz.// People's word. 1992. 29 January. Jumakhoja N. Adizova I. There is no better monument to the word–
                                T .: Uzbekistan, 1995 -P.150
                                <br>
                                <br> [1] Laffasiy H. Tazkirai shuaro. Manuscript fund of the Institute of Oriental Studies of the Russian Academy of Sciences. Inv.№
                ...
                <div class="item features-image сol-12 col-md-6 col-lg-4">
                    <div class="item-wrapper">
                        ...
                        <div class="item-content">
                            ...
                            <h6 class="item-subtitle mbr-fonts-style mt-1 display-7"><strong>Adabiy muhit va badiiy ijod
                                    qirralari</strong></h6>
                            <p class="mbr-text mbr-fonts-style mt-3 display-7">Ma`lumki, Xorazm adabiy muhiti oʻzbek
                                mumtoz adabiyotining yuksak darajada ravnaq topgan va ma`naviyatimiz takomilida oʻchmas
                                iz qoldirgan markazlaridan biridir. Umumoʻzbek adabiyoti taraqqiyotining har bir ...</p>
                        </div>
                        <div class="mbr-section-btn item-footer mt-2"><a href="page4.html#header1-r"
                                                                         class="btn item-btn btn-primary display-7">Batafsil</a>
                            @endif
                        @if($lang=="ru")
                        <div class="item-content">

                            <h6 class="item-subtitle mbr-fonts-style mt-1 display-7"><strong>Литературная среда и художественное творчество
                                    края</strong></h6>
                            <p class="mbr-text mbr-fonts-style mt-3 display-7">Известно, что литературная среда Хорезма узбекская.
                                Высокий уровень развития классической литературы и бессмертие нашей духовности
                                является одним из центров, оставивших свой след. Каждый шаг развития узбекской литературы...</p>
                        </div>
                        <div class="mbr-section-btn item-footer mt-2"><a href="page4.html#header1-r"
                                                                         class="btn item-btn btn-primary display-7">Читать далее</a>
                            @endif
                        @if($lang=="en")
                        <div class="item-content">

                            <h6 class="item-subtitle mbr-fonts-style mt-1 display-7"><strong>Literary environment and artistic creation
                                    edges</strong></h6>
                            <p class="mbr-text mbr-fonts-style mt-3 display-7">It is known that the literary environment of Khorezm is Uzbek
                                The high level of development of classical literature and the immortality of our spirituality
                                is one of the centers that left its mark. Every step of the development of Uzbek literature ...</p>
                        </div>
                        <div class="mbr-section-btn item-footer mt-2"><a href="page4.html#header1-r"
                ...
                <div class="item features-image сol-12 col-md-6 col-lg-4">
                    <div class="item-wrapper">
                        ...
                        <div class="item-content">
                            ...
                            <h6 class="item-subtitle mbr-fonts-style mt-1 display-7"><strong>Manbalardagi biografik
                                    ma`lumotlarning adabiy qimmati</strong></h6>
                            <p class="mbr-text mbr-fonts-style mt-3 display-7">Ma`lumki, tazkira va majmualarda ijodkor
                        ...
                        <div class="mbr-section-btn item-footer mt-2"><a href="page5.html#header1-y"
                                                                         class="btn btn-primary item-btn display-7">Batafsil</a>

                            @endif
                            @if($lang=="ru")
                        <div class="item-content">

                            <h6 class="item-subtitle mbr-fonts-style mt-1 display-7"><strong>Биографические источники
                                    литературная ценность информации</strong></h6>
                            <p class="mbr-text mbr-fonts-style mt-3 display-7">Известно, что он создатель тазкир и комплексов
                                Определенное место отведено биографическим сведениям о человеке, которым является тот или иной художник.
                                служит для расширения общего представления о...&nbsp;<br>
                            </p>
                        </div>
                        <div class="mbr-section-btn item-footer mt-2"><a href="page5.html#header1-y"
                                                                         class="btn btn-primary item-btn display-7">Читать далее</a>
                            @endif
                            @if($lang=="en")
                        <div class="item-content">

                            <h6 class="item-subtitle mbr-fonts-style mt-1 display-7"><strong>Biographical sources
                                    literary value of information</strong></h6>
                            <p class="mbr-text mbr-fonts-style mt-3 display-7">It is known that he is a creator of tazkira and complexes
                                There is a certain place for biographical information about the person, who is this or that artist
                                serves to expand the general idea about ...&nbsp;<br>
                            </p>
                        </div>
                        <div class="mbr-section-btn item-footer mt-2"><a href="page5.html#header1-y"
                                                                         class="btn btn-primary item-btn display-7">Read more</a>
                            @endif
                        </div>
                    </div>
                </div>
                <div class="item features-image сol-12 col-md-6 col-lg-4">
                    <div class="item-wrapper">
                        ...
                        <div class="item-content">
                            ...
                            <h6 class="item-subtitle mbr-fonts-style mt-1 display-7"><strong>“Haft shuaro”ning
                                    yaratilishi, nusxalari va tuzilishi</strong></h6>
                            <p class="mbr-text mbr-fonts-style mt-3 display-7">“Haft shuaro”ning maydonga kelishi,
                                yuqorida ta`kidlanganidek, XIX asrning II yarmidan shaxsan Feruz tashabbusi bilan keng
                                avj olgan kitobat va badiiy asarlarni targʻib qilish, umuman, kitobxonlik miqyosining
                                kengayishi...</p>
                        </div>
                        <div class="mbr-section-btn item-footer mt-2"><a href="page6.html#header1-13"
                                                                         class="btn btn-primary item-btn display-7">Batafsil</a>
                            @endif
                            @if($lang=="ru")
                                <div class="item-content">

                                    <h6 class="item-subtitle mbr-fonts-style mt-1 display-7"><strong>Хафт Шуаро
                                            создание, копии и структура</strong></h6>
                                    <p class="mbr-text mbr-fonts-style mt-3 display-7">Формирование Хафт Шуаро,
                                        Как уже говорилось выше, со второй половины XIX века по инициативе лично Феруза
                                        Продвижение книг и произведений искусства в целом, масштабы чтения в целом
                                        расширение ...</p>
                                </div>
                                <div class="mbr-section-btn item-footer mt-2"><a href="page6.html#header1-13"
                                                                                 class="btn btn-primary item-btn display-7">Читать далее</a>
                                    ...
                                    @if($lang=="en")
                                        <div class="item-content">
                                            ...
                                            <h6 class="item-subtitle mbr-fonts-style mt-1 display-7"><strong>Of Haft Shuaro
                                                    creation, copies and structure</strong></h6>
                                            <p class="mbr-text mbr-fonts-style mt-3 display-7">Formation of Haft Shuaro,
                                                As mentioned above, since the second half of the XIX century, on the initiative of Feruz personally
                                                The promotion of books and works of art in general, the scale of reading in general
                                                expansion ...</p>
                                        </div>
                                        <div class="mbr-section-btn item-footer mt-2"><a href="page6.html#header1-13"
                                                                                         class="btn btn-primary item-btn display-7">Read more</a>
